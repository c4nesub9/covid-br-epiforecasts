...
rc_url <- url("https://github.com/epiforecasts/covid-regional/raw/master/brazil/data/region_codes.rds")
region_codes <- readRDS(rc_url)
close(rc_url)
